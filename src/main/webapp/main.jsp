...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
            ...
            <div align="center" style="padding-top: 50px">
                <font color="grey" size="10">后台系统</font>
            </div>
        </div>
    </div>
</div>
<div region="west" style="width: 200px;height:500px;" title="导航菜单"
    ...
    <div class="easyui-accordion">
        ...
        <div title="门票管理" data-options="iconCls:'icon-shuji'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 全部门票','allBooksManage.jsp','icon-shuben')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-shuben'"
                    style="width: 150px;">全部门票</a>
        </div>
