...
<table id="dg" title="门票信息管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th field="title" width="110" align="center">旅游地</th>
        <th field="author" width="70" align="center">导游</th>
        ...
        <th field="pages" width="50" align="center">/公里</th>
        <th field="publisher" width="120" align="center">旅游公司</th>
...
<div id="tb">
    <div>
        &nbsp;标题：&nbsp;<input type="text" id="biaoti" size="20"
                              onkeydown="if(event.keyCode==13) searchBook()"/>&nbsp;&nbsp;导游：&nbsp;<input
...
<script type="text/javascript">
    ...
    function openbookInfoPage(id) {
        window.parent.openTab('摆放信息', 'storeInfo.jsp?id=' + id,
                'icon-shujias');
    }
